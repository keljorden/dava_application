...
add_frame(left_paned,top_left_paned, 1)
...
top_left_data_desc_frame = create_frame(top_left_paned, relief=tk.SUNKEN, height=150)
...
visualize_btn = add_button(top_left_file_control_frame, text="Visualize")
...
#mid-left partition
add_lable(mid_left_frame, text="Dataset Preview", font=("Arial", 10, "bold")).pack(pady=5)
